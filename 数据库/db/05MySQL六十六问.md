...
![img](img/c12221aa5a804a658c30ea4cf9457098~noop.image ':size=30%')
...
![img](img/d326818622004e1ebdaf0135c873f99f~noop.image ':size=30%')
...
![img](img/274e674c2225481d8b126a3b0ac7a39d~noop.image ':size=30%')
...
![img](img/e1f1eba2024f471eb1a32ac6d233f806~noop.image ':size=30%')



- 水平分库：以字段为依据，按照一定策略（hash、range 等），将一个库中的数据拆分到多个库中。

![img](img/8406b935ff774dc187360e890ddc1d56~noop.image ':size=30%')
...
![img](img/fd7fd56a07004daab1d8c81edd34bf18~noop.image ':size=30%')
...
![img](img/ae5ad401afa44c73ad8962782d02154e~noop.image ':size=30%')
...
![img](img/b2f5e0c689e04df2b795a6bf2c2ab137~noop.image ':size=30%')
...
![img](img/37d3a1bd8909469b9123866091ebd9e4~noop.image ':size=30%')
...
![img](img/565b2425c47b41aabbe4939b23d4668f~noop.image ':size=30%')
...
![img](img/215a6f121cc44c0cb55548539d8a694e~noop.image ':size=30%')
...
![img](img/6e89c7e408ff436a854f2133ec3213fc~noop.image ':size=30%')
...
![img](img/d782c48224344435b1875c907e8363f3~noop.image ':size=30%')
...
![img](img/d68742f30ef54687813eb093b1615d46~noop.image ':size=30%')
...
![img](img/e1d1a417f74145cb9882b5dcf3c12b34~noop.image ':size=30%')
...
![img](img/735202f3d440427ca49b8e37e1664e4f~noop.image ':size=30%')
...
![img](img/0d3b5da6b46f45439e183d6e903b1ef1~noop.image ':size=30%')
...
![img](img/4800727c45b2407cb71adbc86ddc4a1d~noop.image ':size=30%')
...
![img](img/e836e3132c3543c8b6c62c02f15a3c52~noop.image ':size=30%')
...
![img](img/a441ae64092c4445a41960c5ebb47a10~noop.image ':size=30%')
...
![img](img/68bc21ed3fc84353b19fb5afa07625fe~noop.image ':size=30%')
...
![img](img/24a624c477104f2cbba780d333c22dd4~noop.image ':size=30%')
...
![img](img/ca8a873198994907a5c55ccc98659ff6~noop.image ':size=30%')
