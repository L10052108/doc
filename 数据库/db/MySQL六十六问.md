...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/82fc61147ad6498ea3062d6a3e4f0bf7~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=G6rX2mEggd4ORLzYUoy2dQsZaVo%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/a527cc09ef7e40938bd3796a98a856d6~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=%2FDIQW%2BAqbCvgCoXR0bN46ftBGh0%3D)
...
10. 为了满足最左前缀匹配原则
11. 创建组合索引，而不是修改单列索引。
12. 组合索引代替多个单列索引（对于单列索引，MySQL基本只能使用一个索引，所以经常使用多个条件查询时更适合使用组合索引）
13. 过长的字段，使用前缀索引。 当字段值比较长的时候，建立索引会消耗很多的空间，搜索起来也会很慢。我们可以通过截取字段的前面一部分内容建立索引，这个就叫前缀索引。
14. 不建议用无序的值(例如身份证、UUID )作为索引
15. 当主键具有不确定性，会造成叶子节点频繁分裂，出现磁盘存储的碎片化
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/41d554f59043496a8321dfe48a177ce2~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=7%2BOaQs3niV1ZDKlACbvMqnZMaT0%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/37eaba7fde734f37b57c522aaa6f3b12~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=tWd5TQrvH5t3AreoRJE2W5Z%2B7W4%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/1d0d8da6e37a4d85b8a43ec0991cf43e~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=8NpkZO0bLBTC%2B87WUDk4L5fqPhU%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/cb767889889142a89d0023489ff81e2e~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=KmU8ZJ15XrJPag1eUr7hpwCvEhY%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/918068cfc0024368b5e599bc59a0a609~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=dr3Y5J8b7nLzSsyLKdpOC7%2F%2BlOQ%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/e2f3c0638ad3492b9a72c16e4651a811~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=5od6NVgawZbE2rPMaxe6kpDJQ7M%3D)
...
![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/34dd463f4caa4febac9845396ba6460c~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=vSWvRJyVV6o86oj%2BouGqVUxbcO4%3D)



但是，使用了索引下推优化，把where的条件放到了引擎层执行，直接根据name like '张%' and age=10的条件进行过滤，减少了回表的次数。

![img](https://p3-sign.toutiaoimg.com/tos-cn-i-qvj2lq49k0/efc11e8df4134dd3b95539e9ae33f736~noop.image?_iz=58558&from=article.pc_detail&x-expires=1691561800&x-signature=0k5u59E2i27tO4LMD5aAcatgI%2F4%3D)
