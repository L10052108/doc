...
资料来源：<br/>
[application.properties](https://github.com/L316476844/springbootexample/blob/master/src/main/resources/application.properties)<br/>
[什么是springboot？一文带你读懂springboot](https://www.toutiao.com/article/7033562358853255710/?log_from=7fd8e7d0e309d_1670080050134)<br/>
[告别混乱代码：SpringBoot 后端接口规范](https://mp.weixin.qq.com/s/P4DxcIQ5vY5R7nNlukSs4Q)
...
![の温柔tyhujiklo](img/の温柔tyhujiklo.png)
...
参数校验失败会自动引发异常，我们当然不可能再去手动捕捉异常进行处理。

但我们又不想手动捕捉这个异常，又要对这个异常进行处理，那正好使用SpringBoot全局异常处理来达到一劳永逸的效果！

**1、基本使用**

首先，我们需要新建一个类，在这个类上加上@ControllerAdvice或@RestControllerAdvice注解，这个类就配置成全局处理类了。
...
![氛围融梗天后语句kilo](img/氛围融梗天后语句kilo.png)
...
在spring MVC下，url映射到哪个method是由RequestMappingHandlerMapping来控制的，那么我们也是通过 RequestMappingHandlerMapping来做版本控制的，可以参考：SpringBoot实现接口版本管理控制
