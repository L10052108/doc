资料来源：<br/>
[正确使用 acme.sh， 让你的网站永久免费使用 ssl 证书](https://zhuanlan.zhihu.com/p/670418258)<br/>

## 正确使用 acme.sh， 让你的网站永久免费使用 ssl 证书



![img](img/v2-d029b8c8efe89ca7322eb9eeea6f25b7_720w.webp)

[Let's Encrypt - 免费的SSL/TLS证书 (letsencrypt.org)](https://link.zhihu.com/?target=https%3A//letsencrypt.org/zh-cn/)
...
更高级的用法请参考: [https://github.com/Neilpang/acme.sh/wiki/How-to-issue-a-cert](https://link.zhihu.com/?target=https%3A//github.com/Neilpang/acme.sh/wiki/How-to-issue-a-cert)
...
更详细的 api 用法: [https://github.com/Neilpang/acme.sh/blob/master/dnsapi/README.md](https://link.zhihu.com/?target=https%3A//github.com/Neilpang/acme.sh/blob/master/dnsapi/README.md)
...
详细参数请参考: [https://github.com/Neilpang/acme.sh#3-install-the-issued-cert-to-apachenginx-etc](https://link.zhihu.com/?target=https%3A//github.com/Neilpang/acme.sh%233-install-the-issued-cert-to-apachenginx-etc)
...
请参考： [https://github.com/Neilpang/acme.sh/wiki/How-to-debug-acme.sh](https://link.zhihu.com/?target=https%3A//github.com/Neilpang/acme.sh/wiki/How-to-debug-acme.sh)
...
[https://github.com/Neilpang/acme.sh/wiki](https://link.zhihu.com/?target=https%3A//github.com/Neilpang/acme.sh/wiki)
...
![img](img/v2-8156bd0091a170024942abc6a76a0e84_720w.webp)

image-20231204222242650
