...
[idea安装Jrebel实现服务代码热更新](https://blog.csdn.net/qdsd_1898/article/details/142333216)<br/>
...
>  HowSwap是Idea自带功能, 但是有诸多限制(可以认为仅支持方法内的代码的热加载)
>
> - 只能增加字段/方法, 不能减少字段/方法
> - 只能维持已有方法签名, 不能修改
> - …
>
> 使用HowSwap + JRebel的方式, 可以解决 HowSwap的限制问题.

```
Run -> Edit Configurations
```

![img](img/49b71e2d60e3b0d769419616b88c59f5.png)



设置` On 'Update' action 为 Update classes and resources`

![img](img/0c2ef9f8b3222a2b44fa7384e012f40e.png)



部分版本配置如下

![img](img/d5d42675a99f884fa06efbf5cd5a6e48.png)

配置好后, 当前服务左侧会出现刷新按钮

![img](img/19f7d02bf75b22fdbfc1b51c8c362d80.png)

此时可以点击按钮, 进行update, 同时JRebel也会进行检测更新.
...
在`View—>Tool Windows—>JRebel`中打开JRebel的视图，勾选上需要启动热部署的项目，具体效果如下图所示, 但是实际我使用中不去配置这个也可以正常热部署

![img](img/b11ae21fd8f762955d5512213911bbba.png)

考虑关闭Reactor调试模式

![img](img/68b37c91a238cc324f00bee61811f522.png)
